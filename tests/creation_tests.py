    ...
    def test_create_story(self):
        ...
        with PublicTestServerConnection.getV1Meta() as v1:
            ...
            try:
                ...
                self.assertTrue(False, message="Error creating new story: " + str(e))
            ...
            self.assertThat(len(createdItems), GreaterThan(0), message="Created item can't be queried")
